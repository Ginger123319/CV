...
from model_nets.nets import ssd
...
class SSD(object):
    ...
    def __init__(self, image_size, work_dir, **kwargs):
        pth_list = os.listdir(work_dir+'/middle_dir_ssd_dis/normal_train_best_model_dir')
        pth_path = ''
        for i in pth_list:
            if i.endswith('.pth'):
                pth_path = i
        ...
        self._defaults = {
            "model_path"        : work_dir+'/middle_dir_ssd_dis/normal_train_best_model_dir/' + pth_path,
            "classes_path"      : work_dir+'/middle_dir_ssd_dis/data_info/classes.txt',
