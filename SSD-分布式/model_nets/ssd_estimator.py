...
class SSDEstimator(UserDefinedEstimator):
    ...
    def fit(self, X, y, **kwargs):
        ...
        if int(os.environ.get("RANK")) == 0: 
            ...
            logs_list_dir = os.listdir(self.work_dir + '/middle_dir_ssd_dis/logs')
            ...
            for i in val_key_list:
                os.system('cp %s %s' % (self.work_dir + '/middle_dir_ssd_dis/logs/' + i, self.pth_logs_dir))
            ...
            for i in val_key_list_1:
                os.system('cp %s %s' % (
                self.work_dir + '/middle_dir_ssd_dis/logs/' + i, self.work_dir + '/middle_dir_ssd_dis/normal_train_best_model_dir'))
    ...
    def persist_model(self, fs, step_path):
        ...
        fs.copy(self.work_dir + '/middle_dir_ssd_dis/data_info/classes.txt', step_data_path)
        fs.copy(self.work_dir + '/middle_dir_ssd_dis/logs/' + self.best_model_pth, step_data_path)
