...
from classifier_multi.classifier_multi_utils import check_data
...
if __name__ == '__main__':
    ...
    model_id = '2a2ffd0a-7a90-4032-89c6-27cc73003e20'
    label_col = 'label'
    ...
    if only_predict:
        ...
        # 加载保存的模型
        model = main_utils.load_pipeline_model(model_url=model_dir_check, work_dir=work_dir)
        print(model.net)
        ...
        # ===============================================
        # 保存待上传的模型
        model = MyModel(class_name=class_name)
