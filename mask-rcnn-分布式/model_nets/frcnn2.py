...
class FRCNN(object):
    ...
    def __init__(self, work_dir, **kwargs):
        pth_list = os.listdir(work_dir+'/middle_dir_mask_dis/normal_train_best_model_dir')
        pth_path = ''
        for i in pth_list:
            if i.endswith('.pth'):
                pth_path = i
        ...
        self._defaults = {
            "model_path": work_dir+'/middle_dir_mask_dis/normal_train_best_model_dir/' + pth_path,
            "classes_path": work_dir+'/middle_dir_mask_dis/data_info/classes.txt',
            "backbone": "resnet50",
            "confidence": 0.5,
            "iou": 0.3,
            "cuda": False,
    ...
    def detect_image(self, image):
        ...
        # font = ImageFont.truetype(size=np.floor(3e-2 * np.shape(image)[1] + 0.5).astype('int32'))
