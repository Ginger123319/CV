...
if __name__ == '__main__':
    ...
    if only_predict:
        ...
        checkpoint = torch.load(r'D:/Python/pretrained_weights/checkpoints/efficientnet_b7_lukemelas-dcc49843.pth')
        ...
        # split train val
        df_train, df_val = model.split_train_val(df_init, df_anno, is_first_train, val_size=val_size,
                                                               random_seed=1)
        # 训练预测使用的参数
        Config = {
            "class_num": class_num,
