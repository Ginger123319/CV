...
import cfg
from yolov5n_practice import CSPDarknet, C3, Conv
...
if __name__ == '__main__':
    yolo_body = YoloBody(cfg.ANCHORS_GROUP1, 2, 'n')
    data = torch.randn(4, 3, 416, 416)
    print(yolo_body(data)[0].shape, yolo_body(data)[1].shape, yolo_body(data)[2].shape)
